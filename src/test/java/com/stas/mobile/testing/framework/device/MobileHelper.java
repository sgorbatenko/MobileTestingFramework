...
public class MobileHelper {
	...
	public static boolean changeContext(String desiredContext,
	...
	public void swipeWithDirection(SwipeDirection direction,
			MobileElement element, AppiumDriver driver, int swipeDuration) {
		switch (direction) {
		case RIGHT:
