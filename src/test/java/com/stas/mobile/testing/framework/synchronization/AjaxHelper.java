...
public class AjaxHelper {
	...
	public void waitForElementForNoTimeout(UIData element, boolean appear,
		...
		waitForElementWithSelectorForNoTimeout(absoluteSelector, appear,
				timeout);
	}
	...
	public void waitForElementWithSelectorForNoTimeout(String absoluteSelector,
		...
		try {
			waitForElementAppearanceChangedForTimeout(absoluteSelector, appear,
					timeout);
	...
	public void waitForElementWithSelectorAppearanceChange(String selector,
			boolean appear) {
		waitForElementWithSelectorAppearanceChangeForTimeout(selector, appear,
				60);
	}
	...
	public void waitForElementWithSelectorAppearanceChangeForTimeout(
		...
		Function<WebDriver, Boolean> function = new Function<WebDriver, Boolean>() {
			...
			public Boolean apply(@SuppressWarnings("unused") WebDriver input) {
	...
	public void dragAndDrop(String whatSelector, String whereSelector) {
		this.logger.debug("Dragging '" + whatSelector + "' to '"
				+ whereSelector + "'");
