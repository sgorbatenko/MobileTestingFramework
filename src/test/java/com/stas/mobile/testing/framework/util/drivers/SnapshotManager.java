...
public class SnapshotManager
{
    ...
    private static LogController logger = new LogController(SnapshotManager.class);
    ...
    public static String takeScreenshot(String methodName, WebDriver driver)
    {
        ...
        if (env.getTakeSnapShots())
        {
            ...
            {
                target = takeRemoteDeviceSnapShot(snapshotName, (AppiumDriver) driver);
            }
    ...
    {
        File tempScreenshot = (File) ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
        snapshotName = WebDriverWrapper.getRunId() + "_" + snapshotName + ".png";

//        s3.writeStringFileInBucket(snapshotName, tempScreenshot);
//
//        logger.info(String.format("Stored snapshot here - [%s]", new Object[]{s3
//            .getSignedS3URLForObject(snapshotName)}));
//        return s3.getSignedS3URLForObject(snapshotName);
        return "update path";
    }

    public static String takeRemoteSnapShot(String snapshotName, WebDriver driver)
    {
        File f = (File) ((ScreenShotRemoteWebDriver) driver).getScreenshotAs(OutputType.FILE);
        snapshotName = WebDriverWrapper.getRunId() + "_" + snapshotName + ".png";
...
//        return s3.getSignedS3URLForObject(snapshotName);
    ...
    public static String takeRemoteDeviceSnapShot(String snapshotName, AppiumDriver driver)
    {
        File f = (File) driver.getScreenshotAs(OutputType.FILE);
        snapshotName = WebDriverWrapper.getRunId() + "_" + snapshotName + ".png";
//
//        s3.writeStringFileInBucket(snapshotName, f);
//        logger.info(String.format("Stored snapshot here - [%s]", new Object[]{s3
