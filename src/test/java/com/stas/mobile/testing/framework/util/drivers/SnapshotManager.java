...
//        String formattedSnapshotName = WebDriverWrapper.getRunId() + "_" + snapshotName
//            + ".png";
    ...
    public static String takeRemoteSnapShot(String snapshotName,
        WebDriver driver)
    {
        // File f = ((ScreenShotRemoteWebDriver) driver).getScreenshotAs(OutputType.FILE);
        String formattedSnapshotName = WebDriverWrapper.getRunId() + "_" + snapshotName
            + ".png";
        ...
        // .getSignedS3URLForObject(snapshotName)}));
        // return s3.getSignedS3URLForObject(snapshotName);
        return "update path" + formattedSnapshotName;
    }
